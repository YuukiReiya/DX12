...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance,
  ...
  // Register class and create window
  {
    ...
    wcex.lpszClassName = L"GuiWindowClass";
    ...
    HWND hwnd = CreateWindowExW(
        0, L"GuiWindowClass", L"Gui", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT,
        CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr,
        hInstance, nullptr);
    // TODO: Change to CreateWindowExW(WS_EX_TOPMOST, L"GuiWindowClass", L"Gui",
...
#pragma region imgui
	...
	// ちなみにちゃんとImguiを組み込みたいときは
   // まずはこのウィンドウプロシージャを改変するところからがいいかもめ
   // キーボードとマウス入力を持っていかれるので。。。
